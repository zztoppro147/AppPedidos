...
// Using lucide-react icons. Let's define them as JSX elements.
...
const ColumnsIcon = () => <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><line x1="12" x2="12" y1="3" y2="21"/></svg>;
...
export const NAVIGATION_ITEMS: { id: Screen, label: string; icon: React.ReactElement }[] = [
    { id: 'dashboard', label: 'Panel de Control', icon: <LayoutDashboardIcon /> },
    { id: 'pedidos', label: 'Pedidos', icon: <ShoppingCartIcon /> },
    { id: 'diseño', label: 'Diseño', icon: <ListIcon /> },
    { id: 'albaran', label: 'Albarán', icon: <ClipboardIcon /> },
    { id: 'incidencias', label: 'Incidencias', icon: <ColumnsIcon /> },
    { id: 'calendario', label: 'Calendario', icon: <CalendarIcon /> },
    { id: 'importar-pedidos', label: 'Importar Pedidos', icon: <UploadIcon /> },
    { id: 'importar-incidencias', label: 'Importar Incidencias', icon: <AlertTriangleIcon /> },
];